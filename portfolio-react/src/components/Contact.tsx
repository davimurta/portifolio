    ...
    <section id="contact" className="contact section" ref={ref}>
      <div className="container">
        ...
        <div className="contact-content">
          ...
          >
            <h3 className="info-title">Informacoes de Contato</h3>
            ...
            <div className="info-item">
              ...
              <div>
                ...
                <a href="mailto:contato@seudominio.com" className="info-value">contato@seudominio.com</a>
              </div>
            </div>
            ...
            <div className="info-item">
              ...
              <div>
                <span className="info-label">Localizacao</span>
